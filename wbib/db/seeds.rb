references = Reference.create(
  [
    ...
    { URL: 'wikipedia.org', topic: 'Depeche Mode', annotation: 'Source viable enough for the 80\'s' } 
    { URL: 'wikipedia.org', topic: 'Napoleon Dynamite', annotation: 'I wouldn\'t trust this source!' }
    { URL: 'wikipedia.org', topic: 'Wikipedia', annotation: 'Wiki-ception... such meta' }
